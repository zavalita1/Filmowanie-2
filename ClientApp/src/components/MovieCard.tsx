  ...
  if (isPlaceholderCardProps(props)) {
    ...
    return (
      <Card className="w-3xs m-2 mr-10 justify-center bg-gray-100">
        <CardHeader>
          <CardDescription className="text-2xl text-neutral-950 text-center"><b>{props.movie.title}</b></CardDescription>
        </CardHeader>
      </Card>
    );
  }
...
const NonPlaceholderMovieCard: React.FC<VoteableMovieCardProps | ReadOnlyMovieCardProps> = props => {
  ...
  const cardClassName = clsx([
    ...
    "m-2",
    "mr-10", 
    "hover:bg-emerald-100 hover:cursor-pointer",
    props.isMobile ? '' : '',
  ...
  return (
    ...
    <DrawerContent className="bg-gradient-to-tr from-emerald-100 to-sky-100">

...
internal sealed class MovieThatCanBeNominatedAgainEnricherVisitor : IMovieThatCanBeNominatedAgainEnricherVisitor
{
    ...
    public async Task<OperationResult<NominationsFullDataDTO>> SignUp(OperationResult<(NominationsDataDTO, DomainUser)> input, CancellationToken cancellationToken)
    {

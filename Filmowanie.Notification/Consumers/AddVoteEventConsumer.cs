...
{
    private readonly ILogger<AddVoteEventConsumer> logger;
    ...
    {
        this.logger.LogInformation($"Consuming {nameof(AddVoteEvent)}...");
        ...
        this.logger.LogInformation($"Consumed {nameof(AddVoteEvent)} event.");
    }
}